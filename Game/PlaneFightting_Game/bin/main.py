...
from Game.PlaneFightting_Game.config.settings import *
from Game.PlaneFightting_Game.src.plane import OurPlane  # 导入我们的飞机
from Game.PlaneFightting_Game.src.enemy import SmallEnemy
from Game.PlaneFightting_Game.src.bullet import Bullet
